...
* Understanding the implication of existing visualisation choices with real-world data.
...
* Visualize MRP estimation using existing visualisation (Case: Estimating the US 2016 Presidential Vote outcomes using CCES and ACS data)
* Create better way to visualise the result MRP. 
  ]]
]]
.column[.content[
  ###Preliminary result
    
Based on the systematic literature review, this plot displays the existing practice of visualizing MRP. 
