...
```{r common-axis, fig.cap="Common values put in plots' axis. Axis in diagnostic plots more varied compared to communication plot.", fig.height=8, fig.width=6, warning = FALSE, message = FALSE}
```
...
```{r facet-plots, fig.cap = "The facetting variable in MRP visualisations", fig.out = "80%"}
```
