...
state_est_base <- state_estimation_base %>%
  ...
  summarize(mean = mean(value),
            out = ifelse(value < 0.4, 0, 1),
            sd = sqrt(mean(out)*(1-mean(out))/4000)) %>%
  slice_head(n=1) %>%
  select(-out)
```
...
p1 <- ggplot(comparison_data, aes(y = base_model, x = truth, ymin = base_model-sd_base_model, ymax = base_model+sd_base_model)) +
  geom_point(color = "#DE0100", size = 1) +
  geom_abline(intercept = 0, linetype = "dotted") +
...
p2 <- ggplot(comparison_data, aes(y = intent, x = truth, ymin = intent-sd_intent, ymax = intent+sd_intent)) +
  geom_point(color = "#DE0100", size = 1) +
  geom_abline(intercept = 0, linetype = "dotted", size = 0.5) +
  geom_errorbar(color = "#DE0100", size = 0.3) +
  scale_x_continuous(limits = c(0, 1)) +
...
p3 <- ggplot(comparison_data, aes(y = party, x = truth, ymin = party-sd_party, ymax = party+sd_party)) +
  geom_point(color = "#DE0100", size = 1) +
  geom_abline(intercept = 0, linetype = "dotted", size = 0.5) +
  geom_errorbar(color = "#DE0100", size = 0.3) +
  scale_x_continuous(limits = c(0, 1)) +
...
p4 <- ggplot(comparison_data, aes(y = modelb, x = truth, ymin = modelb-sd_modelb, ymax = modelb+sd_modelb)) +
  geom_point(color = "#DE0100", size = 1) +
  geom_abline(intercept = 0, linetype = "dotted", size = 0.5) +
  geom_errorbar(color = "#DE0100", size = 0.3) +
  scale_x_continuous(limits = c(0, 1)) +
...
p5 <- ggplot(comparison_data, aes(y = modelc, x = truth, ymin = modelc-sd_modelc, ymax = modelc+sd_modelc)) +
  geom_point(color = "#DE0100", size = 1) +
  geom_abline(intercept = 0, linetype = "dotted", size = 0.5) +
  geom_errorbar(color = "#DE0100", size = 0.3) +
  scale_x_continuous(limits = c(0, 1)) +
