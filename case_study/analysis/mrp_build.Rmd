...
ggplot(race_metrics, aes(y = metrics, x = values, color = level)) +
...
ggplot(educ_metrics, aes(y = metrics, x = values, color = level)) +
  geom_point() +
...
ggplot(age_metrics, aes(y = metrics, x = values, color = level)) +
  geom_point() +
...
ggplot(age_metrics2, aes(y = metrics, x = values, color = level)) +
  geom_point() +
  scale_color_manual(values = c("#fcc5c0", "#fa9fb5", "#f768a1", "#c51b8a", "#7a0177","#616A6B")) +
  ggtitle("Estimation performance criteria by age level",
